# METHOD:
# 1. make a DataFrame (empire) of the league members and their favorite team. If multiple members like the same team, they are RANDOMLY ASSIGNED a team for their empire foundation. ITS RANDOM. NO COLLUSION. FUCK OFF
...
# 4. use random.choice (why random.choice? because it is easy. It is cryptographically secure or some shit like that? No. Go suck a dick, fate stuck you with the Buffalo Bills) to align a league member with a team. Assign this team name to the league member in the empire DataFrame. Iterate through the league member list until they are all gone.
